...
export default function Navbar() {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-50">
      ...
      <div className="hidden lg:block bg-my-black py-1 sm:py-1">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 w-full relative">
        <nav className="rounded-[20px] sm:rounded-[30px] flex items-center justify-between mt-2 sm:mt-4 bg-white border border-gray-200 shadow-lg px-4 sm:px-8 py-3 sm:py-4 h-[70px] sm:h-[85px]">
        ...
        <div className={`absolute right-0 top-0 h-full w-80 max-w-[85vw] bg-white shadow-2xl transform transition-transform duration-300 ease-in-out ${
          ...
          <div className="p-6 border-b border-gray-200">
            <button
              ...
              className="w-full bg-my-black text-my-white hover:bg-my-gray border border-my-black rounded-full px-6 py-3 font-medium transition-all duration-300 text-center"
            >
              Free Consultation
            </button>
          </div>
